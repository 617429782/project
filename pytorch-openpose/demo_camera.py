...
cap = cv2.VideoCapture(0)    # cv2.VideoCapture()的参数为0：打开笔记本的内置摄像头；参数为路径：即打开指定视频
cap.set(3, 640)     # 第一个参数表示所要设置的视频的参数，例如：3表示帧的宽度、4表示帧的高度
cap.set(4, 480)     # 所以这两句表示将视频流的帧的(宽，高)设置成(640，480)
while True:
